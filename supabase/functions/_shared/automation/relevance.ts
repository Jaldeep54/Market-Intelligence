// Deno port of src/lib/automation/relevance.ts -- byte-for-byte identical
// logic (no Node/browser-specific APIs in the original, so nothing had to
// change). Keep both copies in sync if the keyword list or scoring changes.
//
